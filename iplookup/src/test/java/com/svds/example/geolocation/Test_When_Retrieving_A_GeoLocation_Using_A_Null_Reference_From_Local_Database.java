...
public class Test_When_Retrieving_A_GeoLocation_Using_A_Null_Reference_From_Local_Database {
	...
	public void setupForEachTest() {
		...
		location.setLatitude(36.3018D);
		location.setLongitude(-94.1215D);
		location.setNameOfIsp("AT&T U-Verse");
		location.setOrganization("AS7018 AT&T Services, Inc.");
	}
